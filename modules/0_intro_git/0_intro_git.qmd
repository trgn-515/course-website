...
# 3. The git workflow: clone, edit, commit, push
To submit an assignment in this class, you need to follow these four steps.
...
If you already have a github account, you can link it. Otherwise, you need to create one. Once you accept the link, you have to select your name from the roster. Your repository will be automatically created.

## Step 1: Connect git repository to the cluster.
...
# ...OR add everything in the current folder
git add .
...
::: {.callout-note}
Download the assignment_template.md file provided in Canvas (or copy it from the section below).
